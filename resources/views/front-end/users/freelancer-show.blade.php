                                ...
                                <div class="wt-userprofile">
                                    ...
                                    <div class="wt-title">
                                        ...
                                        <span>
											...
											<img src="/uploads/icons/badge_mailVerif.png" style=" width: 25px; "> Email vérifié
											<br>
											@endif
											<img src="/uploads/icons/badge_nbJob.png" style=" width: 25px; "> 0 jobs effectués
											<br>
											 @if ($user->validation_document === 1)
											<img src="/uploads/icons/badge_identiteVerif.png" style=" width: 25px; "> Identité vérifiée
											<br>
											@endif
											 @if ($profile->voiture === 1)
											<img src="/uploads/icons/vehicule4.png" style=" width: 25px; "> Il a une voiture
											@else
											<img src="/uploads/icons/vehicule4.png" style=" width: 25px; "> Il n'a pas de voiture
											@endif
                                        </span>
                                    </div>
                                </div>
