            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 float-left">
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-securityhold tab-pane la-menu-setting" id="wt-menu-settings">
                            @if (file_exists(resource_path('views/extend/back-end/admin/settings/menu/index.blade.php')))
                                @include('extend.back-end.admin.settings.menu.index')
                            @else
                                @include('back-end.admin.settings.menu.index')
                            @endif
                        </div>
                    </div>
                </div>
