<nav id="wt-nav" class="wt-nav navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse wt-navigation" id="navbarNav">
       ...
       @if (!Auth::check())
            ...
            <li class="scroll-to-section"><a href="{{route('register')}}">Devenir Maalam</a></li>
            ...
            <!--  <li><div class="gradient-button"><a id="modal_trigger" href="#modal"><i class="fa fa-sign-in-alt"></i>Demande S.O.S</a></div></li> -->
