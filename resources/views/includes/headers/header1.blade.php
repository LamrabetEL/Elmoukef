                                        ...
                                        <form method="POST" action="{{ route('login') }}" class="wt-formtheme wt-loginform do-login-form">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="wt-logininfo" style="text-align:center">
													<a href="#"><img src="https://www.dpreview.com/files/p/articles/4698742202/facebook.jpeg" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;"></a>
													<a href="#"><img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-suite-everything-you-need-know-about-google-newest-0.png" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;"></a>
													<a href="/sign-in/linkedin"><img src="https://iconarchive.com/download/i97467/sicons/flat-shadow-social/linkedin.ico" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;"></a>
												</div>					
                                            </fieldset>
