...
class FreelancerController extends Controller
{
    ...
    public function index()
    {
		...
		$cattt = array();
		$categorie = DB::table('catables')->where('catable_id', $profile->id)->where('catable_type', "App\Profile")->get();
		foreach ($categorie as $cat)
		{
			$cattt[] = $cat->category_id;
		}
        ...
        $voiture = !empty($profile->voiture) ? $profile->voiture : '';
