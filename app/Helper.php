...
class Helper extends Model
{
    ...
    {
        $data = array();
        $data['title'] = 'Qu’est-ce qu’un Maalam chez El moukef ?';
        $data['subtitle'] = 'Roam Around With Your Business';
        $data['description'] = '<p>Nous vous proposons un concept de vente de services entre particuliers ou professionnels. 
